        ...
        <PageBg>
            ...
            <BrandPanel>
                ...
                <BrandContent>
                    ...
                    <BrandTagline>Bergabung sekarang dan nikmati<br />pengalaman pesan makanan terbaik.</BrandTagline>
                    <BrandDivider />
                    <BrandFeatures>
                        <BrandFeatureItem>✓ &nbsp;Daftar gratis, tanpa biaya</BrandFeatureItem>
                        <BrandFeatureItem>✓ &nbsp;Bonus voucher untuk member baru</BrandFeatureItem>
                        <BrandFeatureItem>✓ &nbsp;Lacak pesanan secara real-time</BrandFeatureItem>
                    </BrandFeatures>
                </BrandContent>
            </BrandPanel>
            ...
            <FormPanel>
                <FormScroll>
                    <FormCard>
                        <FormTitle>Daftar</FormTitle>
                        <FormSub>Buat akun baru, gratis! 🎉</FormSub>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <SubmitBtn type="submit" disabled={status === 'process'}>
                                {status === 'process' ? 'Mendaftar...' : 'Daftar Sekarang'}
                            </SubmitBtn>
                        </form>
                        ...
                        <FooterText>
                            Sudah punya akun? <FooterLink to="/login">Masuk sekarang</FooterLink>
                        </FooterText>
                    </FormCard>
                </FormScroll>
            </FormPanel>
