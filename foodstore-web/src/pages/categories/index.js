...
const AdminCategories = () => {
    ...
    return (
        <>
            <AdminLayout title="Kategori" subtitle="Kelola kategori produk">
                <TableCard>
                    <TableTopBar>
                        <div />
                        <AddBtn onClick={openAdd}>+ Tambah Kategori</AddBtn>
                    </TableTopBar>
                    <DataTable
                        columns={columns}
                        data={categories}
                        ...
                        noDataComponent={<Empty>Belum ada kategori.</Empty>}
            ...
            {showModal && (
                <Overlay>
                    <Modal>
                        <ModalHeader>
                            <h2>{selectedCategory ? 'Edit Kategori' : 'Tambah Kategori'}</h2>
